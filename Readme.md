...
- **Enter a Google Sheets URL**: Paste a Google Sheets URL in the text input box.
  ...
  <img width="864" alt="Screenshot 2024-11-09 at 11 29 48 AM" src="https://github.com/user-attachments/assets/d5470e1f-2847-4793-b89a-53ff24be1db9">
...
3. **Click "Extract Information"**: Start the extraction process. The AI will retrieve relevant data for up to 100 unique rows.
   ...
   <img width="864" alt="Screenshot 2024-11-09 at 11 31 24 AM" src="https://github.com/user-attachments/assets/d52abac3-22ba-4a5b-950b-d0c1bc8b9e3d">
...
## Walkthrough Video
---
For a visual walkthrough of the setup and usage of **AI Agent for Sheets**, check out the video [here](https://youtu.be/z4x88bInS_g).
